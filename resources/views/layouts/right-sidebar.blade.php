<div class="right-bar">
    <div data-simplebar class="h-100">
        ...
        <div class="p-4">
            ...
            <h6 class="mt-1 mb-3 pt-2">Modo Diseño</h6>
            ...
            <h6 class="mt-4 mb-3 pt-2">Color Barra Arriba</h6>
            ...
            <h6 class="mt-4 mb-3 pt-2 sidebar-setting">Barra Lateral</h6>
            ...
            <div class="form-check sidebar-setting">
                ...
                <label class="form-check-label" for="sidebar-size-small">Pequeño (Vista Iconos)</label>
            </div>

            <h6 class="mt-4 mb-3 pt-2 sidebar-setting">Barra Lateral Color</h6>
            ...
            <div class="form-check sidebar-setting">
                ...
                <label class="form-check-label" for="sidebar-color-colored">Colorido</label>
            </div>
